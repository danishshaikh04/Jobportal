  ...
  return (
    <div className="w-full py-5 lg:py-10">
      <div className="container mx-auto flex flex-col items-center">
        <h3 className="text-3xl md:text-4xl lg:text-6xl flex justify-center items-center text-center tracking-tighter lg:max-w-xl font-regular pb-8 w-full">
          Trusted by market leaders
        </h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-10 items-center mx-auto">
          <div className="relative w-full col-span-4 sm:col-span-6 lg:col-span-10">
              ...
              <CarouselContent>
                {logos.map((logo, index) => (
                  <CarouselItem className="basis-1/2 sm:basis-1/3 lg:basis-1/5" key={index}>
                    <div className="flex items-center justify-center bg-white w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 p-2 rounded-md shadow-md">
                      <img
                        src={logo}
